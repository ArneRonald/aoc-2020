    ...
    for (var i = 0; i < input.length; i++) {
        for (var j = 0; j < input.length; j++) {
            if (input[i] + input[j] == 2020) {
                console.log(input[i])
                console.log(input[j])
                console.log("Answer: " + input[i] * input[j])
                break;
        ...
        for (var j = 0; j < input.length; j++) {
            for (var k = 0; k < input.length; k++) {
                if (input[i] + input[j] + input[k] == 2020) {
                    ...
                    console.log(input[j])
                    console.log(input[k])
                    console.log("Answer: " + input[i] * input[j] * input[k])
                    break;
                }
            }
        }
